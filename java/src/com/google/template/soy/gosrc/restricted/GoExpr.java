...
/**
 * Value class to represent a Go expression. Includes the text of the expression as well as the
 * precedence of the top-most operator.
 *
 * <p> Important: This class may only be used in implementing plugins (e.g. functions, directives).
 *
 * <p> Note that even though the precedence numbers we use are for Soy, the precedence ordering of
 * the Soy expression operators matches that of Go (as well as Go), so the precedence numbers
 * are correct when used for generating Go code as well.
 *
 * @author Kai Huang
 */
public class GoExpr {
  ...
  /**
   * @param text The Go expression text.
   * @param type The type of the result.
   * @param precedence The precedence of the top-most operator. Or Integer.MAX_VALUE.
   */
  public GoExpr(String text, Class<?> type, int precedence) {
    this.text = text;
    this.type = type;
  ...
  /** Returns the Go expression text. */
