...
/**
 * Interface for a Soy print directive implemented for the Go Source backend.
 *
 * <p> Important: This may only be used in implementing print directive plugins.
 *
 * @author Kai Huang
 */
public interface SoyGoSrcPrintDirective extends SoyPrintDirective {
   ...
   */
  public GoExpr applyForGoSrc(GoExpr str, List<GoExpr> args);
