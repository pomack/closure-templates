...
/**
 * Interface for a Soy function implemented for the Go Source backend.
 *
 * <p> Important: This may only be used in implementing function plugins.
 *
 * @author Kai Huang
 */
public interface SoyGoSrcFunction extends SoyFunction {


  /**
   * Computes this function on the given arguments for the Go Source backend.
   *
