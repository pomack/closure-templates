...
package com.google.template.soy.gosrc;
...
/**
 * Compilation options for the Go Src output target (backend).
 *
 * @author Kai Huang
 */
public class SoyGoSrcOptions implements Cloneable {
   ...
   * shouldGenerateGoMsgDefs is true.
   */
  ...
  @Override public SoyGoSrcOptions clone() {
    try {
      return (SoyGoSrcOptions) super.clone();
    } catch (CloneNotSupportedException cnse) {
      throw new RuntimeException("Cloneable interface removed from SoyGoSrcOptions.");
    }
  }
