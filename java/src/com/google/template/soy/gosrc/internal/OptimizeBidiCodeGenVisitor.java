...
class OptimizeBidiCodeGenVisitor extends AbstractSoyNodeVisitor<Void> {
  ...
  OptimizeBidiCodeGenVisitor(
		  Map<String, SoyGoSrcFunction> soyGoSrcFunctionsMap, BidiGlobalDir bidiGlobalDir) {
  ...
  @Override protected void visitSoyFileSetNode(SoyFileSetNode node) {
    ...
    if (! (soyGoSrcFunctionsMap.containsKey(BIDI_MARK_FN_NAME) &&
           soyGoSrcFunctionsMap.containsKey(BIDI_START_EDGE_FN_NAME) &&
           soyGoSrcFunctionsMap.containsKey(BIDI_END_EDGE_FN_NAME))) {
      return;
    }
